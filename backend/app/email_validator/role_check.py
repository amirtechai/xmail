...
_ROLE_LOCALS: frozenset[str] = frozenset({
    ...
    "bounce", "abuse", "spam", "marketing", "newsletter", "billing",
    "accounts", "hr", "jobs", "careers", "press", "media", "legal",
    "privacy", "security", "compliance", "service", "services", "customerservice",
    "feedback", "enquiries", "enquiry", "inquiry", "inquiries",
})
